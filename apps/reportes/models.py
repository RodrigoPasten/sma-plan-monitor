...
class ParametroReporte(models.Model):
    ...
    tipo_parametro = models.CharField(_("Tipo de Parámetro"), max_length=20, choices=TIPO_PARAMETRO_CHOICES)
    ...
    opciones = models.JSONField(_("Opciones"), blank=True, null=True,
...
class ReporteGenerado(models.Model):
    ...
    fecha_generacion = models.DateTimeField(_("Fecha de generación"), null=True, blank=True)
    ...
    archivo = models.FileField(_("Archivo generado"), upload_to='reportes/', null=True, blank=True)
...
class Visualizacion(models.Model):
    ...
    configuracion = models.JSONField(_("Configuración"),
